...
extension UIView {
    ...
    func cornerRadiusWithShadow(radius: CGFloat, color: UIColor = UIColor.white, shadowOpacity: Float = 0.8, shadowRadius: CGFloat = 2, shadowColor: UIColor = UIColor.lightGray) {
        let shadowLayer = CAShapeLayer()
        shadowLayer.path = UIBezierPath(roundedRect: self.bounds,
